...
namespace QuanLyKinhDoanhVangBacDaQuy
{
    public partial class FormService : Form
    {
        ...
        {
            string CustomerId = comboBox2.SelectedItem.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (textBox14.Text == "" || (textBox14.Text != "Đã giao" && textBox14.Text != "Chưa giao"))
            {
            ...
            else
            {
                ...
                dt.Rows.Add((dt.Rows.Count + 1).ToString(), int.Parse(comboBox1.Text), textBox1.Text, float.Parse(textBox2.Text), float.Parse(textBox3.Text), number, price * number, pre_pay, left_money, date.ToString("yyyy-MM-dd "), textBox14.Text.ToString());
